...
namespace WhiteboardCSharp
{
    public class Challenge46
    {
        ...
        {
            Console.WriteLine("       Challenge 46");
            Console.WriteLine(WeekdayRobWasBornInDutch(new DateTime(1970, 9, 21)));
            Console.WriteLine(WeekdayRobWasBornInDutch(new DateTime(1945, 9, 2)));
            Console.WriteLine(WeekdayRobWasBornInDutch(new DateTime(2001, 9, 11)));
        }
