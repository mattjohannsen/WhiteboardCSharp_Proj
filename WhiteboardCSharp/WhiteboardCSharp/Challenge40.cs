...
namespace WhiteboardCSharp
{
    public class Challenge40
    {
        ...
        {
            Console.WriteLine("       Challenge 40");
        ...
        {
            string nonLettersRemoved = Regex.Replace(inputString, "[^a-zA-Z0-9]", String.Empty);
            List<char> stringAsList = nonLettersRemoved.ToList();
