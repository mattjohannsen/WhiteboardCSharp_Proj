...
namespace WhiteboardCSharp
{
    public class Challenge25
    {
        ...
        {
            return (Char.IsUpper(inputChar)) ? Char.ToLower(inputChar) : (Char.IsLower(inputChar)) ? Char.ToUpper(inputChar) : (int)inputChar;
        }
...
// if elseif else ternary formula
//z =
//  ifConditional ? ifCode :
//  elseifConditional ? elseifCode :
//  elseCode;